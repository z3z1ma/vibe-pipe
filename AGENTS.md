...
- **ticket-and-doc-churn-low-signal** (99%)
...
- **compound-autolearn-compoundspec** (v1): Generate a CompoundSpec v2 JSON-only autolearn proposal from git diffstat + existing skills, while respecting strict file-scope constraints.
  - .opencode/skills/compound-autolearn-compoundspec/SKILL.md
...
- **phase3-ticket-investigation** (v1): Investigate Phase 3 tickets to clarify scope and determine implementation vs. defer vs. close
  - .opencode/skills/phase3-ticket-investigation/SKILL.md
