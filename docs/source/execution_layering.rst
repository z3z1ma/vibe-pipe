...
.. note::
   This guide covers the three execution layers defined in ADR vp-8783: Operator, Pipeline, and AssetGraph.
...
.. list-table:: Comparison of Execution Layers
   :widths: 25 25 25 25
   :header-rows: 1
   ...
   * - Materialization
     - No
     - No
     - Yes (tables, files, views)
   * - Orchestration
     - No
     - No
     - Yes (scheduling, caching)
   * - Dependencies
     - N/A
     - Linear only
     - Complex DAG
...
- `ADR: Canonical Pipeline Abstractions <../CORE_ABSTRACTION_CONTRACT.md>`_ - Architecture decision defining execution layers
- `API Reference <api/index>`_ - Complete API documentation
- `Getting Started <getting_started>`_ - Installation and basic usage
